<div class="relative">
    ...
    <div class="p-6 bg-white rounded-lg shadow-md transition-all duration-200" wire:loading.class="blur-sm"
        ...
        <div class="space-y-4 mb-6">
            <div>
                <label for="host" class="block text-sm font-medium text-gray-700 mb-1">Host (Hostname or IP
                    Address)</label>
            ...
            <div>
                <label for="port" class="block text-sm font-medium text-gray-700 mb-1">SNMP Port (e.g. 161,
                    2161)</label>
            ...
            <div>
                <label for="community" class="block text-sm font-medium text-gray-700 mb-1">Community (e.g. public,
                    axinplc)</label>
                <input id="community" type="text" wire:model="community"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                    placeholder="e.g., axinple">
            </div>

            <div>
                <label for="oid" class="block text-sm font-medium text-gray-700 mb-1">OID (single OID or Multiple OID
                    separated by comma)</label>
                <input id="oid" type="text" wire:model="oid"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
